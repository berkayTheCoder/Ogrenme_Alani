...
{
    public partial class Kalemlik : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Urol", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BmUserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Iyelik", x => new { x.UrunId, x.BmUserId });
                    table.ForeignKey(
                        name: "FK_Iyelik_AspNetUsers_BmUserId",
                        column: x => x.BmUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Iyelik_Uruns_UrunId",
                        column: x => x.UrunId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UrunId = table.Column<int>(nullable: false),
                    UrolId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UrunUrol", x => new { x.UrunId, x.UrolId });
                    table.ForeignKey(
                        name: "FK_UrunUrol_Urol_UrolId",
                        column: x => x.UrolId,
                        principalTable: "Urol",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UrunUrol_Uruns_UrunId",
                        column: x => x.UrunId,
                        principalTable: "Uruns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
