...
{
    public partial class Dukkan : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maliyeti = table.Column<decimal>(nullable: false),
                    Stok = table.Column<int>(nullable: false),
                    Resim = table.Column<string>(nullable: true),
                    KategoriId = table.Column<int>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    UreticiId = table.Column<string>(nullable: true),
                    ToptanciId = table.Column<string>(nullable: true),
                    PerakendeciId = table.Column<string>(nullable: true),
                    AliciId = table.Column<string>(nullable: true),
                    AliciId1 = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Uruns_AspNetUsers_AliciId1",
                        column: x => x.AliciId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Uruns_AspNetUsers_UreticiId",
                        column: x => x.UreticiId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Uruns_AspNetUsers_PerakendeciId",
                        column: x => x.PerakendeciId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Iyeliks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Iyeliks_AspNetUsers_MyUserID",
                        column: x => x.MyUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Iyeliks_Uruns_UrunID",
                        column: x => x.UrunID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Yorums_Kategoris_KategoriId",
                        column: x => x.KategoriId,
                        principalTable: "Kategoris",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Yorums_AspNetUsers_YorumcuId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Iyeliks_MyUserID",
                table: "Iyeliks",
                column: "MyUserID");

            migrationBuilder.CreateIndex(
                name: "IX_Iyeliks_UrunID",
                table: "Iyeliks",
                column: "UrunID");

            migrationBuilder.CreateIndex(
                name: "IX_Uruns_AliciId1",
                table: "Uruns",
                column: "AliciId1");

            migrationBuilder.CreateIndex(
                name: "IX_Uruns_UreticiId",
                table: "Uruns",
                column: "UreticiId");

            migrationBuilder.CreateIndex(
                name: "IX_Uruns_PerakendeciId",
                table: "Uruns",
                column: "PerakendeciId");
