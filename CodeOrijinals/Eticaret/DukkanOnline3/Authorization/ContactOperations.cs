...
namespace DukkanOnline3.Authorization
{
    ...
    public class Constants
    {
        ...
        public static readonly string Bakici = "Bakici";
        public static readonly string Musteri = "Musteri";
        public static readonly string Alici = "Alici";
        public static readonly string Yorumcu = "Yorumcu";
    }
}