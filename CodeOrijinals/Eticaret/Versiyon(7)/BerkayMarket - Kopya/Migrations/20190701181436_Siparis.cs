        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SiparisVerenUserId = table.Column<string>(nullable: true),
                    UrunId = table.Column<int>(nullable: false),
                    SiparisAlanUserId = table.Column<string>(nullable: true),
                    SiparisDurumu = table.Column<int>(nullable: false),
                    Miktari = table.Column<int>(nullable: false),
                    SiparisMetni = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Siparis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Siparis_AspNetUsers_SiparisAlanUserId",
                        column: x => x.SiparisAlanUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Siparis_AspNetUsers_SiparisVerenUserId",
                        column: x => x.SiparisVerenUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Siparis_SiparisAlanUserId",
                table: "Siparis",
                column: "SiparisAlanUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Siparis_SiparisVerenUserId",
                table: "Siparis",
                column: "SiparisVerenUserId");
