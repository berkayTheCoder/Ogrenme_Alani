...
namespace KendiDukkanim.Controllers
{
    public class KategorisController : Controller
    {
        ...
        public KategorisController(KendiDukkanimContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("KategoriID,Adi,Budget,StartDate,RowVersion")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KategoriID,Adi,Budget,StartDate,RowVersion")] Kategori kategori)
        {
