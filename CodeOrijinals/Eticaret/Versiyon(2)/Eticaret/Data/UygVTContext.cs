...
namespace Eticaret.Data
{
    ...
    /// </summary>
    public class UygVTContext : IdentityDbContext<EticaretUser, EticaretRole, string, EticaretUserClaim, EticaretUserRole, EticaretUserLogin, EticaretRoleClaim, EticaretUserToken>
    {
        public UygVTContext(DbContextOptions<UygVTContext> options)
            : base(options)
        {
        }
